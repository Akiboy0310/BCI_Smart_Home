...
def main():
    ...
    # print((df_ds2['label'] == 'light_dim').sum())
    # print(df_ds1.count())
    # print(df_1_features.count())
    # print((df_1_features['label'] == 'light_on').sum())
    # print((df_1_features['label'] == 'light_off').sum())
    # print((df_1_features['label'] == 'light_bright').sum())
    # print((df_1_features['label'] == 'light_dim').sum())
    # print(df_ds2.count())
    # print(df_2_features.count())
    # print((df_2_features['label'] == 'light_on').sum())
    # print((df_2_features['label'] == 'light_off').sum())
    # print((df_2_features['label'] == 'light_bright').sum())
    # print((df_2_features['label'] == 'light_dim').sum())
    ...
    #                train_test_valid_MLP(df_1_features, hlayer, neuron, maxIter, activation, 3)
    #                train_test_valid_MLP(df_2_features, hlayer, neuron, maxIter, activation, 4)
